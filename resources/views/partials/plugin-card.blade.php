						...
						<ul class="dropdown-menu">
							<li class="settings-btn">
								<a class="dropdown-item text-success"
								   href="{{ route('admin.plugin.settings.edit', $plugin->name) }}">
							...
							@if($plugin->status)
								<li class="uninstall-btn">
									<a class="dropdown-item text-warning" href="javascript:;"
									   data-action="{{ route('admin.plugin.uninstall', $plugin->name) }}"
									   onclick="uninstallPlugin(this)">
							...
							@else
								<li class="install-btn">
									<a class="dropdown-item text-success" href="javascript:;"
									   data-action="{{ route('admin.plugin.install', $plugin->name) }}"
									   onclick="installPlugin(this)">
